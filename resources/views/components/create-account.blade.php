        ...
        <div class="row align-items-center">
            ...
            <div class="offset-lg-1 d-none d-lg-block col-lg-4">
                <div class="form-div p-3">
                    <form method="POST" action="{{ route('register') }}" class="needs-validation custom-validation"
                        novalidate>
                        @csrf
                        <div class="section-heading">
                            <h5>Join Our</h5>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group text-start">
                                    ...
                                    <input type="email" id="email" name="email"
                                        data-parsley-required-message="Enter valid email address" placeholder="Email"
