                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select data-placeholder="Select Parent" name="section_id" value="{{$page->section_id ?? ''}}"  class="form-control select2">
                                            <option value="{{$sections[0]['id']}}">{{$sections[0]['name']}}</option>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select data-placeholder="Select Parent" class="form-control" >
                                            <option value="{{$page->name}}">Select Section</option>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="text" id="content"
                                                placeholder="Name here" value="{{$page->contenct ?? ''}}" >
                                            <div class="invalid-feedback">
                                                Please enter valid name.
                                            </div>
                                        </div>
                                    ...
                                    <div class="file msg"> <div class="col-lg-12 mb-3">
                                        <div class="form-group">
                                            <label for="image" class="control-label">File</label>
                                            <input type="file" class="form-control" name="image" id="content"  />
                                            <div class="invalid-feedback">
                                                Please upload File.
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="4" name="meta_description"
                                                id="meta_description"
                                                placeholder="Meta Description">{{$page->contenct}}</textarea>
                                        </div>
                                    </div>
                                    </div>
                                    <div class="link msg">
                                    <div class="col-sm-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="link" id="link" value="{{$page->contenct ?? ''}}"
