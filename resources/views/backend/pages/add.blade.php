    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <form class="needs-validation" method="POST" action="{{ route('page.store') }}"
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                <label for="slug" class="form-label">Page Order</label>
                                                <input type="number" class="form-control" name="order" id="order"
                                                    placeholder="Page Order" value="{{ old('order') }}" required>
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="link" id="link"
                                                    placeholder="Link here" value="{{ old('link') }}" />
                                                <div class="invalid-feedback">
