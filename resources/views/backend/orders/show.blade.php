    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <form class="needs-validation create-form" method="POST"
                    action="{{ route('orders.update', $order->id) }}" enctype="multipart/form-data" novalidate>
                    <div class="row">
                                                    ...
                                                    <td>&minus; ${{ number_format($order->discount_amount, 2) }}</td>
                                                        ...
                                                        @if (isset($order->additional_amount))
                                                            <tr>
                                                                ...
                                                                <td>${{ number_format($order->additional_amount, 2) }}
                                                                </td>
                                                            </tr>
                                                        @endif
                                                        <tr>
                                                        ...
                                                        <header
                                                            ...
                                                            <div class="row row-format mt-1"
                                                                ...
                                                                <div class="col border"
                                                                    ...
                                                                    ?>
                                                                    <div>{{ $order->firstName . ' ' . $order->lastName }}
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </header>
                                                                ...
                                                                <td style="background: 0 0; border-bottom: none; white-space: nowrap; text-align: right; padding: 10px 20px; font-size: 1.2em; border-top: 1px solid #aaa;"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="2"
                                                                            ...
                                                                            align="right">{{ __('DELIVERY CHARGES') }}
                                                                        </td>
                                                                        <td style="background: 0 0; border-bottom: none; white-space: nowrap; text-align: right; padding: 10px 20px; font-size: 1.2em; border-top: 1px solid #aaa;"
                                                                            align="right">${{ number_format(10, 2) }}
                                                                        </td>
                                                                    </tr>
                                                                    @if (isset($order->additional_amount))
                                                                        <tr>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <hr class="mt-1" />
                                                            <form id="updatePayment" class="needs-validation"
                                                                method="POST" action="{{ route('order.updated') }}"
                                                                novalidate>
                                                                @csrf
                                                                <?php
                                                                // dd($order);
